       ...
       private string _tag = "WifiDirect";
        ...
        public override void OnReceive(Context context, Intent intent)
        {
            ...
            if (WifiP2pManager.WifiP2pStateChangedAction.Equals(action))
            {
                ...
                Log.Debug(_tag, "P2P state changed - " + state);
            }
            ...
            else if (WifiP2pManager.WifiP2pConnectionChangedAction.Equals(action))
            {
                ...
                if (networkInfo.IsConnected)
                {
                    ...
                    _manager.RequestConnectionInfo(_channel, /*fragment*/null);
                }
                else
                {
                    // It's a disconnect
